...
Mesh::Mesh(std::string filename, QVector3D position, QVector3D scale, qreal rotation_x, qreal rotation_y, qreal rotation_z) : Object(position, scale, rotation_x, rotation_y, rotation_z), indexBuffer(QOpenGLBuffer::IndexBuffer){
